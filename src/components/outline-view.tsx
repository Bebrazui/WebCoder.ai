...
import {
  File, FunctionSquare, Building2, Variable, Box, Enum, Interface, Library, Property, EnumMember
} from 'lucide-react';
...
const symbolKindToIcon: Record<monaco.languages.SymbolKind, React.ReactNode> = {
  ...
  [6]: <Property className="h-4 w-4 text-teal-400" />, // Property
  [7]: <FunctionSquare className="h-4 w-4 text-teal-400" />, // Field
  [8]: <FunctionSquare className="h-4 w-4 text-purple-400" />, // Constructor
  [9]: <Enum className="h-4 w-4 text-amber-400" />, // Enum
  [10]: <Interface className="h-4 w-4 text-cyan-400" />, // Interface
  ...
  [21]: <EnumMember className="h-4 w-4 text-teal-400" />, // EnumMember
